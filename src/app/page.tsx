    ...
    <div>
        ...
        <div className='container'>
          <div className='row'>
            <div className='col-lg-8 col-md-6 col-12'>
              <h1 className='hover-underline text-primary lead fs-1 my-5'>Welcome to <strong className='text-dark fw-bold'>Next.js</strong> Project</h1>
              <p className='lead w-75 fs-6'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
      ...
      <section className='py-5'>
        <div className='container'>
          <div className='row'>
            <div className='col-lg-4 col-md-6 col-12'>
            <div className="ripple-image-container">
